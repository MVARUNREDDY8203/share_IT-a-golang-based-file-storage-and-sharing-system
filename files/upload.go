...
//     // Generate a 32-byte encryption key (in practice, this key should be stored securely)
//     encryptionKey := []byte("this_is_a_32_byte_key_for_aes_on") // Replace this with your key management strategy
...
//     _, err = db.DB.Exec("INSERT INTO files (filename, file_type, file_path, user_id, created_at) VALUES (?, ?, ?, ?, ?)",
...
//     // Return the success message and file URL
